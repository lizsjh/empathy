...
botui.message.add({
    ...
    return botui.message.add({
        delay:900,
        loading: true,
        content:'I feel your frustration. I can help you with that. Could you tell me your order number?'
    });
}).then(function(){
    return botui.action.text({
        action: {
    ...
    return botui.message.add({
        delay:900,
        loading: true,
        content:'I have processed your request. I really feel your irritation, and I hope your issue has been addressed.'
    });
}).then(function(){
    sendcomplete();
    return botui.message.add({
